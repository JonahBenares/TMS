...
`user_id` int(11) NOT NULL,
  ...
  `usertype` int(11) NOT NULL DEFAULT '0' COMMENT '1=admin, 2=employee'
...
(1, 'admin', 'admin', 'admin', 1, 1, 1, NULL, 1),
(2, 'hen', 'hen', 'Hennelen Tanan', 2, 3, 1, NULL, 2),
(3, 'jason', 'flor', 'Jason Flor', 3, 4, 2, 'jasonflor.cenpri@gmail.com', 2),
(4, 'tep', 'tep', 'Stephine David Severino', 4, 1, 2, NULL, 2),
(6, 'jonah', '12345', 'Jonah Faye Benares', 1, 2, 1, 'jonahbenares.cenpri@gmail.com', 2);
