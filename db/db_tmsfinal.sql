...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 11, 2019 at 03:03 AM
...
(5, 5, 'Planning', '14.00', '2019-11-11', '2019-11-12', 4, '2019-11-11 02:36:25'),
(6, 2, 'update 1', '50.00', '2019-11-11', '2019-11-15', 2, '2019-11-11 03:01:02');
...
INSERT INTO `project_head` (`project_id`, `start_date`, `completion_date`, `project_title`, `project_description`, `priority_no`, `company_id`, `department_id`, `employee`, `task_no`, `status`, `cancel_date`, `cancel_reason`, `create_date`, `monitor_person`, `from`, `cancel_timestamp`) VALUES
(1, '2019-11-04', '2019-11-20', 'Sample Project', 'Sample Project Description', 1, 1, 1, '2', '001', 1, NULL, NULL, '2019-11-04 03:45:12', 8, 'Verbally', NULL),
(2, '2019-11-07', '2019-11-30', 'Hello World!', 'This is the project description of Hello World Project.', 1, 2, 2, '8', '002', 0, NULL, NULL, '2019-11-07 07:36:23', 2, 'Verbally', NULL),
(3, '2019-11-11', '2019-11-15', 'Security System', 'Security System Project Description', 1, 1, 2, '9', '003', 0, NULL, NULL, '2019-11-11 01:19:35', 2, 'Memo', NULL),
(4, '2019-11-20', '2019-11-16', 'The Finance Project', 'The Finance Project Description', 1, 1, 4, '3, 4, 5', '004', 0, NULL, NULL, '2019-11-11 01:21:58', 5, 'Verbally', NULL),
(5, '2019-11-11', '2019-11-23', 'The Admin', 'The Admin Project Description', 1, 1, 5, '4, 5', '005', 0, NULL, NULL, '2019-11-11 02:35:54', 3, 'Emailed', NULL);
...
INSERT INTO `reminders` (`reminder_id`, `notes`, `employee_id`, `due_date`, `done_date`, `status`, `cancel_date`, `cancel_reason`) VALUES
(1, 'Submit Nov. 2019  Report', '2', '2019-11-30', '2019-11-11 02:40:49', 2, NULL, NULL),
(2, 'Nov 2019 Recom', '6', '2019-11-30', NULL, 0, NULL, NULL);
...
(7, 'kyle', '827ccb0eea8a706c4c34a16891f84e7b', 'Kyle Jambongana', 1, 2, 1, 'kyle@gmail.com', 2),
(8, 'lloyd', '827ccb0eea8a706c4c34a16891f84e7b', 'Lloyd Jamero', 1, 2, 1, 'lloyd@gmail.com', 3);
