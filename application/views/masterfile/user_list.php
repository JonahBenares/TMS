                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <center>
                                    <input type="radio" name="employee" id = "employee" class="form-control ">
                                    Active
                                </center>
                            </div>
                            <div class="col-md-6">
                                        ...
                                        <td>                                            
                                            <div class="table-data-feature">
                                                <span data-toggle="modal" data-target="#updateCompany">
                                                    <a  class="btn btn-info item btn-sm" data-toggle="tooltip" data-id = "" data-name = "" id = "updateEmp_button" data-placement="top" title="Update" >
                                                        <i class="fa fa-pencil-square-o"></i>
                                                    </a>
                                                </span>
                                                
                                                <a href="<?php echo base_url(); ?>masterfile/" class="btn btn-danger item btn-sm" data-toggle="tooltip" data-placement="top" title="Delete" title="Delete" alt='Delete'>
