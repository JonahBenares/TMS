                        ...
                        <div class="table-responsive">   
                            <?php if(!empty($filt)){ ?>     
                                <div class="alert alert-info" role="alert">
                                    ...
                                    <a href='<?php echo base_url(); ?>report/completed_list' class='remove_filter alert-link pull-right btn btn-xs'>
                                                        ...
                                                        <td class="bg-hovr" width="20%" class="nobor-top">
                                                            ...
                                                            <small class="proj-title btn-block m-0">COMPLETED DATE: <span class="pull-right"><?php echo date('m-d-Y', strtotime($ci->project_completed($proj->project_id))); ?></span></small>
                                                                 ...
                                                                 <small class="proj-title btn-block m-0">NO. OF WORKING DAYS: <span class="pull-right">
                                                                  <?php echo $ci->date_diff($proj->start_date, $ci->project_completed($proj->project_id)); ?>
                                                            </span></small>
                                                        </td>
                                                        <td class="bg-hovr" width="35%" class="nobor-top">
                                                            <div class="progress progress-bar-animated active">
                                                               <div class="progress-bar bg-success progress-bar-striped" role="progressbar" aria-valuenow="<?php echo $ci->project_percent($proj->project_id); ?>%" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $ci->project_percent($proj->project_id); ?>%">
